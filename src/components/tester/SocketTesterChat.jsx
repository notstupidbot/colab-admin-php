...
export default function SocketTesterChat (){
    ...
    <div>
      <div className="w-full">
        <div className="relative flex items-center p-3 border-b border-gray-300">
          ...
          <span className="block ml-2 font-bold text-gray-600">{displayName} ({onlineStatus})</span>
          <span className={userCls}>
          </span>
        </div>
        <div className="relative w-full p-6 overflow-y-auto h-[10rem]" id="chat_box" ref={chatBox}>
        ...
        <div className="flex items-center justify-between w-full p-3 border-t border-gray-300">
          ...
          <input type="text" placeholder="Message"
            ...
            name="message" required onKeyDown={(e)=>{_handleKeyDown(e)}}/>
          <button>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
