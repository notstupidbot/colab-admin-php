...
export default function SentenceItemTtf({onResizeItemArea,index,item,config,ws, items, socketConnected,
	...
	const onSynthesizeItem = async (evt, index) => {
		if(!socketConnected){
			doToast('SentenceItemTtf.onSynthesizeItem() Socket not connected !', false)
			return
		}
		// setLoading(true)
