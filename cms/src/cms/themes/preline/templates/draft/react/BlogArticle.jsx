 ...
 <div className={cls0}> 
     <div className={cls1}> 
       ...
       <div className={cls2}> 
         <div className={cls3}> 
           <div className={cls4}> 
             <img src="https://images.unsplash.com/photo-1669837401587-f9a4cfe3126e?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=320&amp;h=320&amp;q=80" alt="Image Description" className={cls5}/> 
           </div> 
                   ...
                   <div className={cls9}> 
                     ...
                     <div role="tooltip" className={cls11}> 
                       ...
                       <div className={cls12}> 
                         <div className={cls13}> 
                           <div className={cls4}> 
                             <img src="https://images.unsplash.com/photo-1669837401587-f9a4cfe3126e?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=320&amp;h=320&amp;q=80" alt="Image Description" className={cls14}/> 
                           </div> 
                       ...
                       <div className={cls17}> 
                         <ul className={cls18}> 
                           <li className={cls19}> 
                             <span className={cls20}> 56 </span> 
                             <span className={cls21}> articles </span> 
                           </li> 
                           <li className={cls19}> 
                             <span className={cls20}> 1k+ </span> 
                             <span className={cls21}> followers </span> 
                           </li> 
                         </ul> 
  
                         <div> 
                           <button type="button" className={cls22}> 
       ...
       <div className={cls27}> 
         <div className={cls28}> 
           ...
           <p className={cls30}> At preline, our mission has always been focused on bringing openness and transparency to the design process. We&apos;ve always believed that by providing a space where designers can share ongoing work not only empowers them to make better products, it also helps them grow. </p> 
         </div> 
  
         <p className={cls30}> We&apos;re proud to be a part of creating a more open culture and to continue building a product that supports this vision. </p> 
  
         <figure> 
           <img src="https://images.unsplash.com/photo-1670272505340-d906d8d77d03?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2070&amp;q=80" alt="Image Description" className={cls31}/> 
           <figcaption className={cls32}> 
            A woman sitting at a table.
           </figcaption> 
         </figure> 
  
         <p className={cls30}> As we&apos;ve grown, we&apos;ve seen how Preline has helped companies such as Spotify, Microsoft, Airbnb, Facebook, and Intercom bring their designers closer together to create amazing things. We&apos;ve also learned that when the culture of sharing is brought in earlier, the better teams adapt and communicate with one another. </p> 
  
         <p className={cls30}> That&apos;s why we are excited to share that we now have a  <a href="#" className={cls33}> free version of Preline </a> , which will allow individual designers, startups and other small teams a chance to create a culture of openness early on. </p> 
  
         <blockquote className={cls34}> 
           <p className={cls35}> 
         ...
         <figure> 
           <img src="https://images.unsplash.com/photo-1670272498380-eb330b61f3cd?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2070&amp;q=80" alt="Image Description" className={cls31}/> 
           <figcaption className={cls32}> 
         ...
         <div className={cls28}> 
           <h3 className={cls37}> Bringing the culture of sharing to everyone </h3> 
  
           <p className={cls30}> We know the power of sharing is real, and we want to create an opportunity for everyone to try Preline and explore how transformative open communication can be. Now you can have a team of one or two designers and unlimited spectators (think PMs, management, marketing, etc.) share work and explore the design process earlier. </p> 
         </div> 
  
         <ul className={cls38}> 
           <li className={cls39}> Preline allows us to collaborate in real time and is a really great way for leadership on the team to stay up-to-date with what everybody is working on,&quot;  <a href="#" className={cls33}> said </a>  Stewart Scott-Curran, Intercom&apos;s Director of Brand Design. </li> 
           <li className={cls39}> Preline opened a new way of sharing. It&apos;s a persistent way for everyone to see and absorb each other&apos;s work,&quot; said David Scott, Creative Director at  <a href="#" className={cls33}> Eventbrite </a> . </li> 
         </ul> 
  
         <p className={cls30}> Small teams and individual designers need a space where they can watch the design process unfold, both for themselves and for the people they work with &#x2013; no matter if it&apos;s a fellow designer, product manager, developer or client. Preline allows you to invite more people into the process, creating a central place for conversation around design. As those teams grow, transparency and collaboration becomes integrated in how they communicate and work together. </p> 
  
         <div> 
           <a href="#" className={cls40}> 
            Plan
           </a> 
           <a href="#" className={cls40}> 
            Web development
       ...
       <div className={cls43}> 
         ...
         <div className={cls44}> 
           <button type="button" className={cls45}> 
            ...
            875
             <span role="tooltip" className={cls47}> 
              Like
             </span> 
           </button> 
         </div> 
         ...
         <div className={cls49}> 
           <button type="button" id="blog-article-share-dropdown" className={cls50}> 
             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className={cls46}> 
               <path fillRule="evenodd" d="M3.5 6a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-8a.5.5 0 0 0-.5-.5h-2a.5.5 0 0 1 0-1h2A1.5 1.5 0 0 1 14 6.5v8a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 14.5v-8A1.5 1.5 0 0 1 3.5 5h2a.5.5 0 0 1 0 1h-2z"> </path> 
               <path fillRule="evenodd" d="M7.646.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 1.707V10.5a.5.5 0 0 1-1 0V1.707L5.354 3.854a.5.5 0 1 1-.708-.708l3-3z"> </path> 
             </svg> 
            Share
           </button> 
           <div aria-labelledby="blog-article-share-dropdown" className={cls51}> 
             <a href="#" className={cls52}> 
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className={cls46}> 
