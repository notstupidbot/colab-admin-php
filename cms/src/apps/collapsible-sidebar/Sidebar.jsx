  ...
  return (
    <div
      className={classNames({
        "sidebar bg-indigo-700 text-zinc-50 fixed md:static md:translate-x-0 z-20":
          true,
        "transition-all duration-300 ease-in": true,
        "w-[300px]": !collapsed,
        "w-16": collapsed,
    ...
    >
      ...
      >
        ...
        <div
          className={classNames({
            "flex items-center border-b border-b-indigo-800 trnsition-none":
              true,
            "p-4 justify-between": !0,
